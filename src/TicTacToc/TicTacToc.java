...
public class TicTacToc {
    public static int A1, A2, A3, B1, B2, B3, C1, C2, C3;
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i <=9; i++) {
            ...
            if (i < 9) {
                ...
                System.out.println("I will play at " + computer);
...
// result of X or O in disply screen
